...
The answer: VBAN treats that incoming stream as a *hardware input source*, not a virtual output. It doesn’t automatically forward that signal anywhere, you must explicitly **route it** to one of the B outputs (B1 or B2) if you want other apps (OBS) to pick it up.
